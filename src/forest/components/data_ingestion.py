...
from src.forest.data_access.forestdata import ForestData  

# what is data class?
# a dataclass is shortcut in python  to create classes that are mainly used to store data  
# dataclass module is introduced in Python 3.7 as a utility tool to make structured classes 
# specially for storing data. These classes hold certain properties and functions to deal 
